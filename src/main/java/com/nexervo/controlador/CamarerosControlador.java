...
public class CamarerosControlador implements PrincipalControlador.NecesitaUsuario {
    ...
    public void onGuardar() {
        ...
        if (modoEdicion) {
            ...
            // Verificar que el login no lo usa otro
            if (!loginPerteneceAOtro(login, id)) {
    ...
    /** Comprueba que el login no lo use OTRO usuario (el mismo ID está permitido). */
    private boolean loginPerteneceAOtro(String login, int idPropio) {
