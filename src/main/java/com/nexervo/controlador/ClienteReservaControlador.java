...
public class ClienteReservaControlador {
    ...
    private boolean validar() {
        ...
        // Exactamente 9 dígitos (el listener ya impide letras)
        ...
        // Email opcional; si se rellena, debe tener formato correcto
        ...
        if (!ok) {
            alerta("Completa los campos marcados en rojo antes de continuar.");
