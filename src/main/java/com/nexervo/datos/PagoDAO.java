 ...
 *   PENDIENTE/AUTORIZADA → DEVUELTA    (cancelación o no se presentó)
 *
...
public class PagoDAO {
    ...
    public int crearPreautorizacion(int idReserva, BigDecimal importe) {
        ...
        try (Connection conn = conexion.getConexion();
            ...
            log.error("Error al crear preautorización", e);
        }
        return -1;
    }
    ...
    public PreautorizacionPago obtenerPorReserva(int idReserva) {
        ...
        try (Connection conn = conexion.getConexion();
            ...
            log.error("Error al obtener preautorización por reserva", e);
        }
        return null;
    }
    ...
    public boolean cambiarEstado(int idPago, String nuevoEstado) {
        ...
        try (Connection conn = conexion.getConexion();
            ...
            log.error("Error al cambiar estado de preautorización", e);
            return false;
        }
    }
